...
public class Talking2 : MonoBehaviour
{
    [Header("Player")]
    ...
    public IEnumerator StartDialogue()
    {
        ...
        Pop(player);
        StartTalking("얘들아, 안녕! 오랜만이야. 근데 지금 문제가 생겼어. ", 4.0f, playerBox, playerText);
        yield return new WaitForSeconds(4.0f);
        ...
        yield return new WaitForSeconds(1.0f);
        Pop(AR); //아리
        StartTalking("무슨 문제인데??", 3f, dialogueBox2, dialogueText2);
        yield return new WaitForSeconds(3.0f);
        Del(dialogueBox2, AR); //텍스트박스 퇴장

        yield return new WaitForSeconds(1.0f);
        Pop(player);
        StartTalking("아지의 게임기가 사라졌어. 그래서 같이 찾아봐야 할 것 같아.", 4f, playerBox, playerText);
        yield return new WaitForSeconds(4.0f);
        Del(playerBox, player);

        yield return new WaitForSeconds(1.0f);
        Pop(DO); //땅오
        StartTalking("아진짜? 그래 다같이 찾는걸 도와주자.", 4f, dialogueBox4, dialogueText4);
        yield return new WaitForSeconds(4.0f);
        Del(dialogueBox4, DO);

        yield return new WaitForSeconds(1.0f);
        Pop(player);
        StartTalking("일단 내가 한명씩 질문을 할거야.", 3f, playerBox, playerText);
        yield return new WaitForSeconds(3.0f);
        Del(playerBox, player);
    ...
    public IEnumerator Dialogue2() {
        ...
        Pop(player);
        StartTalking("그래? 아지 게임기는 본 적 없어?", 3f, playerBox, playerText);
        yield return new WaitForSeconds(3.0f);
        Del(playerBox, player);
    ...
    public IEnumerator Dialogue3() {
        ...
        Pop(AR);
        StartTalking("근데 그거 모래사장 위에 놓고온 것 같은데 아마 놀이터에 가면\n찾을 수 있을거야.", 6f, dialogueBox2, dialogueText2);
        yield return new WaitForSeconds(6.0f);
        Del(dialogueBox2, AR);
